    ...
    $.fn.banner = function (options) {
        ...
        if (this._obj.autoPlay) {
            ...
            this.hover(function () {
                ...
                $(".banner-box").find("input").fadeIn()
                // $(".banner-box").find("input").css("display", "block")
                // console.log($(".banner-box").children("input"));
                ...
                $(".banner-box").find("input").fadeOut()
                // $(".banner-box").find("input").css("display", "none")
                // console.log($(".imgbox").find("input"));
